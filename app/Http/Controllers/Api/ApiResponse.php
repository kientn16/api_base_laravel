...
class ApiResponse
{
    ...
    {
        return $this->setStatusCode(403)->withMessage($message);
    }
    /**
    ...
    {
        return $this->setStatusCode(500)->withMessage($message);
    }
    /**
    ...
    {
        return $this->setStatusCode(404)->withMessage($message);
    }
    /**
    ...
    {
        return $this->setStatusCode(401)->withMessage($message);
    }
    /**
    ...
    {
        return $this->setStatusCode(400)->withMessage($message);
    }
    /**
